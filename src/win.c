...
bool initializeWindow(void)
{
	...
	/* allocate the total amount of bytes to colorbuffer */
	colorBuffer = malloc(sizeof(color_t) * SCREEN_WIDTH * SCREEN_HEIGHT);

	/* SDL_Texture to display the colorbuffer */
...
/**
 * destroyWindow - when the game is over destory window
 *
*/
